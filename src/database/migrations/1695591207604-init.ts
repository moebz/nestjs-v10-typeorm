...
export class Init1695591207604 implements MigrationInterface {
    name = 'Init1695591207604'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products_categories" ADD CONSTRAINT "FK_3e10289edf9fc128cede897c2db" FOREIGN KEY ("category:id") REFERENCES "category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_3e10289edf9fc128cede897c2d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_414c8fc7ae52afaf7b31750fac"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ae02308c93d865ed3dbaa6097f"`);
